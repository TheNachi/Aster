...
class ProductsCVLayout: UICollectionViewLayout {
    ...
    override public func prepare() {
        ...
        if cache.isEmpty {
            ...
            for row in 0 ..< numberOfItems {
                ...
                guard let cellHeight = delegate?.collectionView(collectionView: collectionView, heightForCellAtIndexPath: indexPath, width: cellWidth) else { return }
